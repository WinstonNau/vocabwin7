package com.vocabwin7.vocabwin7;
...
public class GameActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE = "com.vocabwin7.vocabwin7" + TAG;
    public static final String EXTRA_MESSAGE_2 = "com.vocabwin7.vocabwin7" + TAG + ".max";
    ...
    private void setNewText() {
        try {
            ...
            String url = "https://vocabwin.herokuapp.com/falseChoices7?word=" + answerWithoutSpacesAndSharpS + "&lang=" + language + "&speech=" + speech;
