...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE = "com.vocabwin7.vocabwin7.MainActivity";
    ...
    public void onClickDownload(View view) {
        ...
        String url = "https://vocabwin.herokuapp.com/units7/" + id;
    ...
    public void fromToPages(View view) {
        ...
        if(fromTextInt < 168 || toTextInt > 205 || fromTextInt > toTextInt) {
            ...
            String url = "https://vocabwin.herokuapp.com/pages7?from=" + fromText + "&to=" + toText;
